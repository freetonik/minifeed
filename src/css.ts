...
:root {
    ...
    --color-bg-button: #FAFBFC;
    --color-bg-button-disabled: #959da5;
}
...
.button:disabled {
    color: var(--color-bg-button-disabled);
    border-color: var(--color-bg-button-disabled);
    pointer-events: none;
}
...
.fancy-gradient-bg {
    background: linear-gradient(180deg, rgb(178 150 90 / 6%), rgba(178, 155, 90, 0) 56.56%);
}
